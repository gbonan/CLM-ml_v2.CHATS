...
contains
  ...
  !-----------------------------------------------------------------------
  subroutine SoilAlbedo (bounds, num_nourbanc, filter_nourbanc, waterstatebulk_inst, surfalb_inst)
    !
    ! !DESCRIPTION:
    ...
    associate ( &
                                                         ! *** Input ***
    h2osoi_vol => waterstatebulk_inst%h2osoi_vol_col, &  ! Soil layer volumetric water content (m3/m3)
                                                         ! *** Output ***
