module MLCanopyNitrogenProfileMod
  ...
  subroutine CanopyNitrogenProfile (num_filter, filter, mlcanopy_inst)
    ...
    vcmaxpft        => MLpftcon%vcmaxpft             , &  ! CLMml: Maximum carboxylation rate at 25C (umol/m2/s)
    clump_fac       => MLpftcon%clump_fac            , &  ! CLMml: Foliage clumping index (-)
    ...
    do fp = 1, num_filter
       ...
       ! See Bonan et al. (2014) Geosci. Model Dev., 7, 2193-2222, doi:10.5194/gmd-7-2193-2014, eqs. (A1)-(A2)
       ...
       ! See Bonan et al. (2021) Agric. For. Met., 306, 108435, doi:j.agrformet.2021.108435, supplemental eqs. (6)-(12)
       ...
       do ic = ncan(p), 1, -1
          ...
          if (dpai(p,ic) > 0._r8) then
             ...
             ! Leaf variables: assumed to be proportional to leaf nitrogen
             ! See Bonan et al. (2014): eq. (A1)
